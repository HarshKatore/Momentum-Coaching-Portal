...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="relative min-h-[90vh] flex items-center pt-20 pb-20 overflow-hidden bg-slate-950">
        {/* Background Image */}
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <p className="text-lg md:text-2xl text-slate-300 mb-10 max-w-2xl leading-relaxed">
                {SITE.tagline}. Warora's premier coaching institute for JEE Main
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Link
                  href="/courses"
                  className="px-8 py-4 rounded-xl font-bold bg-primary text-white shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 hover:-translate-y-1 transition-all duration-300 flex items-center gap-2"
                >
                  Explore Courses <ArrowRight size={20} />
                </Link>
                <Link
                  href="/contact"
                  className="px-8 py-4 rounded-xl font-bold bg-white/10 text-white backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all duration-300"
                >
                  Contact Us
                </Link>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              We don't just teach; we mentor students to achieve their highest
              potential through a structured, result-oriented approach.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Learn from subject matter experts with years of experience in competitive exams.",
              },
              {
                title: "Comprehensive Material",
                desc: "Well-researched, up-to-date study modules covering NCERT and advanced topics.",
              },
              {
                title: "Regular Assessments",
                desc: "Weekly mock tests and detailed performance analysis to track progress.",
              },
              {
                title: "Doubt Clearing",
                desc: "Dedicated 1-on-1 sessions to ensure conceptual clarity for every student.",
              },
              {
                title: "Personalized Mentoring",
                desc: "Individual attention to guide students through academic and psychological challenges.",
              },
              {
                title: "Proven Track Record",
                desc: "Consistent top ranks in JEE and NEET year after year.",
              },
            ].map((feature, i) => (
              <motion.div
                key={i}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            <div className="max-w-2xl">
              ...
              <p className="text-muted-foreground text-lg">
                Specialized batches designed to target specific competitive
                examinations.
              </p>
            </div>
            <Link
              href="/courses"
              className="inline-flex items-center font-semibold text-primary hover:text-primary/80 gap-2 shrink-0"
            >
          ...
          >
            {featuredCourses.map((course) => (
              <motion.div
                ...
                className="bg-white rounded-2xl p-8 shadow-md border border-border/50 hover:shadow-xl transition-all duration-300 flex flex-col h-full"
              >
                ...
                <p className="text-primary font-medium mb-4">
                  {course.targetExam} • {course.duration}
                </p>
                ...
                <Link
                  href="/contact"
                  className="w-full py-3 rounded-xl border-2 border-primary/20 text-primary text-center font-bold hover:bg-primary hover:text-white transition-colors mt-auto"
                >
                  Enquire Now
                </Link>
              </motion.div>
      ...
      <section className="py-24 bg-slate-950 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mt-12">
            <Link
              href="/results"
              className="inline-flex items-center justify-center px-6 py-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors font-medium gap-2"
            >
      ...
      <section className="py-20 bg-primary relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="text-primary-foreground/90 text-xl max-w-2xl mx-auto mb-10">
            Join Momentum Coaching today and take the first step towards your
            dream college.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              href="/contact"
              className="px-8 py-4 rounded-xl font-bold bg-white text-primary shadow-lg hover:shadow-xl hover:scale-105 transition-all"
            >
              Book a Free Counseling Session
            </Link>
            <a
              href={`tel:${CONTACT.phone.replace(/\s+/g, "")}`}
              className="px-8 py-4 rounded-xl font-bold border-2 border-white text-white hover:bg-white/10 transition-all flex items-center justify-center gap-2"
            >
