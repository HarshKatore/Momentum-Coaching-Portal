    ...
    <div className="min-h-screen bg-white pb-24">
      <PageHeader
        ...
        typedStrings={[
          ...
          "Building future leaders since " + SITE.foundedYear,
          "Where dreams meet determination",
        ]}
      />

      <div className="container mx-auto px-4 sm:px-6 lg:px-8 mt-20">
        <ScrollRevealWrapper origin="bottom" distance="30px" duration={800}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            <div className="relative">
              ...
              <div className="absolute -left-8 top-1/2 -translate-y-1/2 bg-white p-6 rounded-2xl shadow-xl z-20 hidden md:block">
                <div className="text-4xl font-extrabold text-primary mb-1">
                  {new Date().getFullYear() - parseInt(SITE.foundedYear)}+
                </div>
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
                Welcome to {SITE.instituteName}
              </h2>
              <p className="text-lg text-slate-600 mb-6 leading-relaxed text-justify">
                Established in {SITE.foundedYear}, {SITE.instituteName} has
                emerged as a premier coaching institution in {SITE.location}. We
                are dedicated to providing the highest quality education and
                comprehensive preparation for competitive examinations like JEE
                Main, JEE Advanced, NEET, and MHT-CET.
              </p>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed text-justify">
                Our philosophy goes beyond traditional teaching. We believe in
                mentoring students, identifying their unique strengths, and
                addressing their weaknesses to help them achieve their maximum
                potential. With a team of highly qualified faculty and a
                rigorous academic curriculum, we have consistently produced top
                ranks in various state and national level examinations.
              </p>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
            <div className="bg-slate-950 text-white p-10 md:p-14 rounded-3xl relative overflow-hidden group h-full">
              ...
              <p className="text-slate-300 text-lg leading-relaxed relative z-10">
                To impart quality education with a strong foundation of
                concepts, empowering students to excel in competitive exams
                while instilling ethical values and confidence to face global
                challenges.
              </p>
            </div>

            <div className="bg-primary text-white p-10 md:p-14 rounded-3xl relative overflow-hidden group h-full">
              ...
              <p className="text-primary-foreground/90 text-lg leading-relaxed relative z-10">
                To be the most trusted educational institution that creates a
                conducive environment for learning, innovating, and building the
                careers of thousands of aspiring doctors and engineers.
              </p>
            </div>
          </div>
        </ScrollRevealWrapper>
