    ...
    <footer className="bg-slate-950 text-slate-300 pt-16 pb-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-3 inline-block">
              ...
              <div className="flex flex-col">
                <span className="font-bold text-xl text-white leading-tight">Momentum</span>
                <span className="text-[10px] tracking-widest text-primary/80 uppercase leading-none">Coaching Institute</span>
              </div>
            </Link>
            <p className="text-sm text-slate-400 mt-4 leading-relaxed">
              {SITE.tagline}. Dedicated to providing the highest quality education for JEE, NEET, and Board examinations.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href={`mailto:${CONTACT.email}`} className="text-sm hover:text-primary transition-colors break-all">
                  {CONTACT.email}
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-slate-800 text-sm text-center md:flex md:justify-between md:text-left">
          <p>&copy; {currentYear} {SITE.instituteName}. All rights reserved.</p>
